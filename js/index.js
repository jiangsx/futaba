...
function Search(kw) {
	if(useGoogle) {
>>>>>>> 39cbcb169135bd9ed594632d174247acd8ada41f
...
<<<<<<< HEAD
	...
	googleImage.src="https://www.google.com/favicon.ico?" + Math.random().toString();
	googleImage.onload = function() {
		useGoogle = (googleImage.src.indexOf("google") != -1 ? 1 : 0);
	};
	setTimeout("if(useGoogle == -1){useGoogle = 0; googleImage.src='img/icon.png';}",750);
